...
(function (root, factory) {
  ...
  const CARDS = [
    ...
    { id: 'focus', cost: 0,      name: 'Focus',            rarity: C, fx: { insight: 2 },                   flavor: 'Stillness sharpens the mind’s edge.' },
    { id: 'brace', cost: 1,      name: 'Iron Margin',      rarity: C, fx: { block: 9 },                     flavor: 'The border of the page holds fast.' },
    { id: 'cinder', cost: 1,     name: 'Cinder Flick',     rarity: C, fx: { dmg: 4, burn: 3 },              flavor: 'Some pages are best burned.' },
    ...
    { id: 'jotting', cost: 0,    name: 'Hasty Jotting',    rarity: C, fx: { insight: 1, draw: 1 },          flavor: 'Barely legible. Barely enough.' },
    ...
    { id: 'emberink', cost: 1,   name: 'Ember Ink',        rarity: C, fx: { burn: 5 },                      flavor: 'It smolders as it dries.' },
    { id: 'venomink', cost: 1,   name: 'Venom Ink',        rarity: C, fx: { poison: 4 },                    flavor: 'Do not lick the quill.' },
    ...
    { id: 'slash', cost: 1,      name: 'Sigil Slash',      rarity: C, fx: { dmg: 9, selfDmg: 2 },           flavor: 'Carve it fast; the sigil bites back.' },
    { id: 'scribble', cost: 0,   name: 'Frantic Scribble', rarity: C, fx: { insight: 3, selfDmg: 2 },       flavor: 'Insight, at the cost of a nosebleed.' },
    { id: 'margin', cost: 0,     name: 'Margin Note',      rarity: C, fx: { block: 3, insight: 1 },         flavor: 'Small, but it’s always there for you.' },
    { id: 'flick', cost: 1,      name: 'Ash Flick',        rarity: C, fx: { dmg: 4, burn: 2, insight: 1 },  flavor: 'Yesterday’s spell still has heat in it.' },
    { id: 'gash', cost: 1,       name: 'Rune Gash',        rarity: C, fx: { dmg: 8, weak: 1 },              flavor: 'Deep enough to teach a lesson.' },
    ...
    { id: 'wax', cost: 1,        name: 'Wax Seal',         rarity: C, fx: { block: 7, thorns: 1 },          flavor: 'Break it and be burned.' },
    ...
    { id: 'bookbash', cost: 1,   name: 'Book Bash',        rarity: C, fx: { dmg: 10, exhaust: true },       flavor: 'Sometimes the tome IS the weapon.' },
    { id: 'dogear', cost: 0,     name: 'Dog-Ear',          rarity: C, fx: { reveal: 1, exhaust: true },     flavor: 'Mark the page. Never forget.', unlock: null },
    { id: 'glossary', cost: 0,   name: 'Glossary',         rarity: C, fx: { pruneLetters: 3 },              flavor: 'Rule out what it cannot be.' },
    { id: 'chant', cost: 1,      name: 'Low Chant',        rarity: C, fx: { insight: 2, block: 2 },         flavor: 'Hum until the walls agree with you.' },
    { id: 'papershield', cost: 1,name: 'Folio Guard',      rarity: C, fx: { block: 8, draw: 1, exhaust: true }, flavor: 'A thick book stops a thin blade.' },
    { id: 'inkwell', cost: 1,    name: 'Deep Inkwell',     rarity: C, fx: { insight: 2, heal: 2 },          flavor: 'Dip deep, write true.' },
    { id: 'crosshatch', cost: 1, name: 'Crosshatch',       rarity: C, fx: { dmg: 5, block: 4 },             flavor: 'Attack and defense in one stroke.' },
    { id: 'firstdraft', cost: 1, name: 'First Draft',      rarity: C, fx: { dmg: 12, selfDmg: 3, exhaust: true }, flavor: 'Powerful. Unrevised. Dangerous.' },
    { id: 'lullaby', cost: 1,    name: 'Vellum Lullaby',   rarity: C, fx: { weak: 2, heal: 3 },             flavor: 'Sung to books to keep them shut.' },
    { id: 'errata', cost: 0,     name: 'Errata',           rarity: C, fx: { cleanse: true, insight: 1 },    flavor: 'Correct the record. Correct yourself.' },
    { id: 'gleam', cost: 1,      name: 'Gilded Gleam',     rarity: C, fx: { revealVowels: true, exhaust: true }, flavor: 'The vowels catch the light first.' },
    ...
    { id: 'leech', cost: 1,      name: 'Mind Leech',       rarity: U, fx: { dmg: 6, insight: 2 },           flavor: 'Their thoughts, your margin notes.' },
    ...
    { id: 'bloodpact', cost: 0,  name: 'Blood Pact',       rarity: U, fx: { insight: 4, selfDmg: 4 },       flavor: 'Ink runs red today.' },
    { id: 'embargo', cost: 2,    name: 'Embargo Seal',     rarity: U, fx: { block: 8, weak: 1, insight: 1 },flavor: 'Nothing gets in. Nothing.' },
    { id: 'quillstorm', cost: 2, name: 'Quill Storm',      rarity: U, fx: { dmg: 4, hits: 3 },              flavor: 'A murder of pens.' },
    { id: 'siphon', cost: 1,     name: 'Soul Siphon',      rarity: U, fx: { dmg: 7, heal: 5 },              flavor: 'Borrowed vitality, never returned.' },
    { id: 'acid', cost: 1,       name: 'Acid Etching',     rarity: U, fx: { poison: 7 },                    flavor: 'It writes itself deeper each turn.' },
    { id: 'pyre', cost: 2,       name: 'Pyre Glyph',       rarity: U, fx: { dmg: 6, burn: 6 },              flavor: 'A word that keeps on burning.' },
    ...
    { id: 'chillword', cost: 2,  name: 'Chill Word',       rarity: U, fx: { dmg: 8, weak: 2 },              flavor: 'Spoken at absolute zero.' },
    ...
    { id: 'barter', cost: 0,     name: 'Ink Barter',       rarity: U, fx: { goldGain: 18, exhaust: true },  flavor: 'Words are currency, literally.' },
    ...
    { id: 'inkfangs', cost: 1,   name: 'Ink Fangs',        rarity: U, fx: { dmg: 5, poison: 5 },            flavor: 'The bite that keeps biting.' },
    ...
    { id: 'plaguepen', cost: 2,  name: 'Plague Pen',       rarity: R, fx: { poison: 6, burn: 6, weak: 1 },  flavor: 'Its ink was never meant for paper.' },
    ...
    { id: 'stormglyph', cost: 2, name: 'Storm Glyph',      rarity: R, fx: { dmg: 6, hits: 3, insight: 1 },  flavor: 'Thunder, conjugated three ways.' },
    { id: 'hourglass', cost: 2,  name: 'Inverted Hourglass', rarity: R, fx: { stun: 1, exhaust: true },     flavor: 'Steal a moment. Keep it.' },
    { id: 'goldleaf', cost: 0,   name: 'Gold Leaf',        rarity: R, fx: { goldGain: 35, exhaust: true },  flavor: 'Illumination pays.' },
    ...
    { id: 'inkhydra',   cost: 3, name: 'Ink Hydra',        rarity: R, fx: { dmg: 6, aoe: true, poison: 4 },  flavor: 'Cut one stroke, two more answer.' },
    { id: 'starfall',   cost: 4, name: 'Starfall Stanza',  rarity: R, fx: { dmg: 11, hits: 2, aoe: true, exhaust: true }, flavor: 'The sky, quoted at length.', unlock: { kind: 'world', n: 3 } },
    { id: 'voidquill',  cost: 4, name: 'Void Quill',       rarity: R, fx: { dmg: 12, aoe: true, stun: 1, exhaust: true }, flavor: 'It writes in absences.', unlock: { kind: 'power' } },
    ...
    { id: 'seerbolt', cost: 1,   name: 'Seer Bolt',        rarity: C, fx: { dmg: 6, insight: 2 },  starter: true, flavor: 'It strikes where the eye already looked.' },
