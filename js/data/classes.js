...
(function (root, factory) {
  ...
  const DIFFICULTIES = [
    { id: 0, name: 'Novice',   icon: '🕯️', hpMult: 1.0,  dmgMult: 1.0,  goldMult: 1.0, desc: 'The tome opens gently.', unlock: null },
    { id: 1, name: 'Adept',    icon: '📖', hpMult: 1.35, dmgMult: 1.3,  goldMult: 1.35, desc: 'Foes strike harder; aurum flows faster.', unlock: { winsOn: 0 } },
    { id: 2, name: 'Master',   icon: '🔥', hpMult: 1.65, dmgMult: 1.5,  goldMult: 1.7, desc: 'The pages resist being turned.', unlock: { winsOn: 1 } },
